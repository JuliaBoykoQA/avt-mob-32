...
public class CoreTestCase extends TestCase {
    ...
    private DesiredCapabilities getCapabilitiesByPlatformEny() throws Exception {
        ...
        if (platform.equals(PLATFORM_ANDROID)) {
            ...
            capabilities.setCapability("app", "/Users/yuliaboyko/Desktop/avt-mob-32/apks/org.wikipedia.apk");
        } else if (platform.equals(PLATFORM_IOS)) {
            capabilities.setCapability("platformName", "iOS");
            capabilities.setCapability("deviceName", "iPhone SE");
            capabilities.setCapability("platformVersion", "11.3");
            capabilities.setCapability("app", "/Users/yuliaboyko/Desktop/avt-mob-32/apks/Wikipedia.app");
        }else {
